...
ensure_dir "$HQ_PATH/scripts"
ensure_dir "$HQ_PATH/spawns"
...
write_file "$TEMPLATES/hq/scripts/spawn-vibe-chief.sh"        "$HQ_PATH/scripts/spawn-vibe-chief.sh"
chmod +x "$HQ_PATH/scripts/spawn-vibe-chief.sh" 2>/dev/null || true
...
touch_file "$HQ_PATH/spawns/.gitkeep"

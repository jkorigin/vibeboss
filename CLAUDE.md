...
11. **Labs as continuous research function** — `vibeboss-workspace/labs/` mirrors project structure (`research/whatsapp-pa/`, `research/master-dashboard/`, `research/hq/`). Research lead (Ginger) hands findings back to project build leads via their inboxes for adoption.

...
- **Subsystem F-ish — Labs as continuous research function.** `vibeboss-workspace/labs/` mirrors project structure (`research/whatsapp-pa/`, `research/master-dashboard/`, `research/hq/`). Ginger (research lead) born; first 4 research streams kicked off for whatsapp-pa. Three protocols documented: Boss→labs, dev-lead→labs, labs→dev-lead handoff.

...
The path was originally committed as `~/ventures/vibeboss/.claude/hooks/route.sh` — the partner's machine-specific absolute path. This breaks silently on every other clone.
